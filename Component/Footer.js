    ...
    <>
      <div className="bg-gradient-to-r text-[#e0d917] from-footers-default  to-footerend-default px-6  py-16   md:px-20 flex md:flex-row flex-col justify-evenly ">
        ...
        <div className="mt-3 md:mt-6">
          ...
          <Link target="_blank" rel="noopener noreferrer" href={"https://www.facebook.com/people/Vidya-Bharti-HS-School-Chhola-Bhopal/61574639864011/"} >
     
              <IoLogoFacebook onClick={()=>{}} style={{width:"35px",height:"35px"}} className=" mb-2  text-white ml-[30px] w-[2rem] "/>
          
          </Link>
          <Link target="_blank" rel="noopener noreferrer" href={"https://www.instagram.com/vidya_bharti_chhola/"}>
